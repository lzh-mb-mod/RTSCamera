    ...
    public static class Utility
    {
            ...
            out Vec2 weightedAverageCurrentPosition)
        {
            ...
            foreach (var formation in formations)
            {
                ...
                {
                    if (minSpeed > formation.CachedMovementSpeed)
                    {
                        minSpeed = formation.CachedMovementSpeed;
        ...
        public static void MissionOrderVM_OnOrderExecutedWithId(string id)
        {
            ...
            // This is required to keep MissionOrderVM open in rts mode and close it in player mode.
            var missionOrderVM = MissionSharedLibrary.Utilities.Utility.GetMissionOrderVM(Mission.Current);
            var orderItem = MissionSharedLibrary.Utilities.Utility.FindOrderWithId(missionOrderVM, id);
            if (orderItem != null)
            {
