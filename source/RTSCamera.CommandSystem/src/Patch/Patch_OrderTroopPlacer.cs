...
//#endif
        ...
        public static bool Prefix_AddOrderPositionEntity(OrderTroopPlacer __instance, int entityIndex,
            ...
            ref List<GameEntity> ____orderPositionEntities)
        {
            AddOrderPositionEntity(__instance, entityIndex, groundPosition, fadeOut, alpha, ref ____orderPositionEntities);
            return false;
        }
        ...
        public static void AddOrderPositionEntities(List<WorldPosition> agentFrames, bool fadeOut, int startIndex = 0)
        {
            ...
            {
                AddOrderPositionEntity(_orderTroopPlacer, startIndex, GetGroundedVec3(_orderTroopPlacer.Mission, worldPosition), fadeOut, -1f, ref ____orderPositionEntities);
                ++startIndex;
            }
        }
        ...
        private static bool CanUpdate(OrderTroopPlacer __instance, OrderController ____orderController)
        {
            ...
            if (!__instance.Mission.IsNavalRaidBattle ||
                orderController == Mission.Current.PlayerEnemyTeam.MasterOrderController ||
                (__instance.Mission.IsNavalRaidBattle && orderController.Team.Side == BattleSideEnum.Defender))
