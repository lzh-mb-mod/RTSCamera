...
namespace RTSCamera.CommandSystem.Patch
{
    public class Patch_HumanAIComponent
    {
        ...
        public static bool Prefix_GetDesiredSpeedInFormation(HumanAIComponent __instance, Agent ___Agent, ref float __result, bool isCharging)
        {
            ...
            float num1 = mountAgent != null ? mountAgent.MaximumForwardUnlimitedSpeed : ___Agent.MaximumForwardUnlimitedSpeed;
            ...
            if (flag)
            {
                ...
                float num6 = (isCharging ? ___Agent.Formation.QuerySystem.FormationIntegrityData.AverageMaxUnlimitedSpeedExcludeFarAgents : MathF.Min(pendingOrder.FormationSpeedLimits[___Agent.Formation], ___Agent.Formation.QuerySystem.MovementSpeed)) / num1;
