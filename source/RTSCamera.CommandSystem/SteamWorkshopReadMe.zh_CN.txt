...
[h2]推荐[/h2]
[list]
[*]RTS Camera：RTS mod 的另一部分，提供指挥时切换到自由视角的功能。[url=https://steamcommunity.com/sharedfiles/filedetails/?id=3596692403]Steam Workshop[/url]
[/list]
...
[*]你可以在配置菜单中启用“添加防御保持指令”选项，以便向部队下达该指令。下达后，处于防御阵型（盾墙、方阵、圆阵）下的部队会原地固守并保持举盾。
[/list]
...
[list]
[*]检查Modules文件夹，确保没有RTSCamera或者RTSCamera.CommandSystem。如果你使用创意工坊的mod，Modules文件夹不应有同一mod。
[*]如果你使用了下面任何一个mod，请确保它们都更新到最新了
[*]BattleMiniMap战斗小地图
