...
[*]Allows you to give a series of orders and let your troops execute them one by one. For example, move along a given path and then shoot/charge.
...
[h2]Recommended[/h2]
[list]
[*]RTS Camera: another part of the RTS mod, for free camera view when giving orders. [url=https://steamcommunity.com/sharedfiles/filedetails/?id=3747725551]Steam Workshop[/url]
[/list]
...
[*]Hold Ctrl while dragging on the ground to also lock formations' widths.
...
[*]Click middle mouse button - Select/Attack formation
[*]H - Auto volley
[*]J - Manual volley
[*]K - Volley fire
[*]Hold Alt + Click middle mouse button - Attack enemy formation without interrupting previous movement orders
