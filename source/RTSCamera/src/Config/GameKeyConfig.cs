...
namespace RTSCamera.Config
{
    ...
    //    protected override string SaveName => Path.Combine(ConfigPath.ConfigDir, RTSCameraSubModule.ModuleId, nameof(GameKeyConfig) + ".xml");

    //    protected override string[] OldNames { get; } = { Path.Combine(OldConfigPath.OldSavePath, "GameKeyConfig.xml") };
